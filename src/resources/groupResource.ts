...
class GroupResource extends BaseResource {
    ...
    groupArchive(
        ...
        const path = `/api/v1/groups.archive`;
    ...
    groupClose(
        ...
        const path = `/api/v1/groups.close`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupCounters(
        ...
        const path = `/api/v1/groups.counters${this.addQuery(query)}`;
    ...
    groupCreate(
        ...
        const path = `/api/v1/groups.create`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupDelete(
        ...
        const path = `/api/v1/groups.delete`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupFiles(
        ...
        const path = `/api/v1/groups.files${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupHistory(
        ...
        const path = `/api/v1/groups.history${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupInfo(
        ...
        const path = `/api/v1/groups.info${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupInvite(
        ...
        const path = `/api/v1/groups.invite`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupLeave(
        ...
        const path = `/api/v1/groups.leave`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupList(
        ...
        const path = `/api/v1/groups.list${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupListAll(
        ...
        const path = `/api/v1/groups.listAll${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupMembers(
        ...
        const path = `/api/v1/groups.members${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupMessages(
        ...
        const path = `/api/v1/groups.messages${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupModerators(
        ...
        const path = `/api/v1/groups.moderators${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupAddAll(
        ...
        const path = `/api/v1/groups.addAll`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupAddLeader(
        ...
        const path = `/api/v1/groups.addLeader`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupAddModerator(
        ...
        const path = `/api/v1/groups.addModerator`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupAddOwner(
        ...
        const path = `/api/v1/groups.addOwner`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupRemoveLeader(
        ...
        const path = `/api/v1/groups.removeLeader`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupRemoveModerator(
        ...
        const path = `/api/v1/groups.removeModerator`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupRemoveOwner(
        ...
        const path = `/api/v1/groups.removeOwner`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupRename(
        ...
        const path = `/api/v1/groups.rename`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetAnnouncement(
        ...
        const path = `/api/v1/groups.setAnnouncement`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetDescription(
        ...
        const path = `/api/v1/groups.setDescription`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetPurpose(
        ...
        const path = `/api/v1/groups.setPurpose`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetReadOnly(
        ...
        const path = `/api/v1/groups.setReadOnly`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetTopic(
        ...
        const path = `/api/v1/groups.setTopic`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupSetType(
        ...
        const path = `/api/v1/groups.setType`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupUnarchive(
        ...
        const path = `/api/v1/groups.unarchive`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    groupGetIntegrations(
        ...
        const path = `/api/v1/groups.getIntegrations${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    groupConvertToTeam(
        ...
        const path = `/api/v1/groups.convertToTeam`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
}
