...
class RoomResource extends BaseResource {
    ...
    roomAdminRooms(
        ...
        const path = `/api/v1/rooms.adminRooms${this.addQuery(query)}`;
    ...
    roomCleanHistory(
        ...
        const path = `/api/v1/rooms.cleanHistory`;
    ...
    roomInfo(
        ...
        const path = `/api/v1/rooms.info${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomGetDiscussions(
        ...
        const path = `/api/v1/rooms.getDiscussions${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomGet(
        ...
        const path = `/api/v1/rooms.get${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomDelete(
        ...
        const path = `/api/v1/rooms.delete`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomFavorite(
        ...
        const path = `/api/v1/rooms.favorite`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomAutocompleteChannelAndPrivate(
        ...
        const path = `/api/v1/rooms.autocomplete.channelAndPrivate${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomAutocompleteAdminRooms(
        ...
        const path = `/api/v1/rooms.autocomplete.adminRooms${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomAdminRoomsGetRoom(
        ...
        const path = `/api/v1/rooms.adminRooms.getRoom${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomSaveRoomSettings(
        ...
        const path = `/api/v1/rooms.saveRoomSettings`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomNameExists(
        ...
        const path = `/api/v1/rooms.nameExists${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomChangeArchivationState(
        ...
        const path = `/api/v1/rooms.changeArchivationState`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomExport(
        ...
        const path = `/api/v1/rooms.export`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomMuteUser(
        ...
        const path = `/api/v1/rooms.muteUser`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomUnmuteUser(
        ...
        const path = `/api/v1/rooms.unmuteUser`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    roomImages(
        ...
        const path = `/api/v1/rooms.images${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomAuditMembers(
        ...
        const path = `/api/v1/audit/rooms.members${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomMediaUpload(
        ...
        const path = `/api/v1/rooms.media/${rid}`;
    ...
    roomMediaConfirm(
        ...
        const path = `/api/v1/rooms.mediaConfirm/${rid}/${fileId}`;
    ...
    roomRoles(
        ...
        const path = `/api/v1/rooms.roles${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    roomAutocompleteChannelAndPrivateWithPagination(
        ...
        const path = `/api/v1/rooms.autocomplete.channelAndPrivate.withPagination${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
}
