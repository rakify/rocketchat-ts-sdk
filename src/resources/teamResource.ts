...
class TeamResource extends BaseResource {
    ...
    teamListAll(
        ...
        const path = `/api/v1/teams.listAll${this.addQuery(query)}`;
    ...
    teamList(
        ...
        const path = `/api/v1/teams.list${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    teamInfo(
        ...
        const path = `/api/v1/teams.info${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    teamAddRoom(
        ...
        const path = `/api/v1/teams.addRoom`;
    ...
    teamRemoveRoom(
        ...
        const path = `/api/v1/teams.removeRoom`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    teamUpdateRoom(
        ...
        const path = `/api/v1/teams.updateRoom`;
        return this.client.request("POST", path, payload, {}, customHeaders);
    }
    ...
    teamListRooms(
        ...
        const path = `/api/v1/teams.listRooms${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    teamListRoomsOfUser(
        ...
        const path = `/api/v1/teams.listRoomsOfUser${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
    ...
    teamListChildren(
        ...
        const path = `/api/v1/teams.listChildren${this.addQuery(query)}`;
        return this.client.request("GET", path, {}, {}, customHeaders);
    }
}
